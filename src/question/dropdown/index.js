...
export class DropDownList {
  ...
  eventBinding() {
    ...
    document.querySelectorAll(".dropdown-item-box").forEach((item, index) => {
  ...
  dispatchEvent(item) {
    ...
    this.dropdownLabel.querySelector(".dropdown-select-label").innerHTML =
  ...
  selectedDropdownItem(index) {
    document
      .querySelectorAll(".dropdown-item-box")
